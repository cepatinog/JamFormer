...
<<
    ...
    \new ChordNames { \chords {
      ...
      | f1:min5-7 | bes1:9- | es1:min7 | aes1:7 | des2:dim des2:6 | des1:maj | aes1:min7 | des1:7 
      | g1:min5-7 | c1:9- | f1:maj | s1 | aes1:dim | des1:9- | ges1:min7 | aes1:7 
      | f1:min5-7 | bes1:9- | es1:min7 | aes1:7 | des1:dim | des1:6 | des1:dim | des1:6 
      | f1:min5-7|
      }
      }
...

    {
      ...
      \bar "||" b4.. es'16~ es'16 bes16 b8~ b8. aes16 
      | b4 es8 d4. d8 aes8 
      | a2 aes8 a8 des8 c8 
      | r2 aes'8 r8 r8 aes'8~ 
      | aes'8 des'8 r4 c''8. b'16 c''4 
      | g'8. f'16 g'4 \tuplet 3/2 {e'4 c'8} e'8. c'16~ 
      | c'4 c'4 g8 e8 g4 
      | es8 e4 c8 \tuplet 3/2 {d4 c8~} c4 
      \bar "||" \mark \default b4. r8 r2\bar  ".."
    }
    >>
>>    
}
